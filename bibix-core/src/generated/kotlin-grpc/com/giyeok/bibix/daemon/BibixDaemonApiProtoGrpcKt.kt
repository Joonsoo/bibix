...
object BibixDaemonApiGrpcKt {
  ...
  val getIntellijProjectStructureMethod:
      MethodDescriptor<BibixDaemonApiProto.GetIntellijProjectStructureReq,
      BibixDaemonApiProto.IntellijProjectStructure>
    @JvmStatic
    get() = BibixDaemonApiGrpc.getGetIntellijProjectStructureMethod()
  ...
  class BibixDaemonApiCoroutineStub @JvmOverloads constructor(
     ...
     */
    suspend
        fun getIntellijProjectStructure(request: BibixDaemonApiProto.GetIntellijProjectStructureReq,
        headers: Metadata = Metadata()): BibixDaemonApiProto.IntellijProjectStructure = unaryRpc(
      channel,
      BibixDaemonApiGrpc.getGetIntellijProjectStructureMethod(),
      request,
      callOptions,
      headers
    )}
  ...
  abstract class BibixDaemonApiCoroutineImplBase(
     ...
     * com.giyeok.bibix.daemon.BibixDaemonApi.GetIntellijProjectStructure.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend
        fun getIntellijProjectStructure(request: BibixDaemonApiProto.GetIntellijProjectStructureReq):
        BibixDaemonApiProto.IntellijProjectStructure = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.giyeok.bibix.daemon.BibixDaemonApi.GetIntellijProjectStructure is unimplemented"))
    ...
    final override fun bindService(): ServerServiceDefinition = builder(getServiceDescriptor())
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = BibixDaemonApiGrpc.getGetIntellijProjectStructureMethod(),
      implementation = ::getIntellijProjectStructure
    )).build()
  }
}
