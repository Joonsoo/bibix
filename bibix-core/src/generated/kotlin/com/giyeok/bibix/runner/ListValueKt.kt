...
public inline fun listValue(block: com.giyeok.bibix.runner.ListValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.runner.BibixValueProto.ListValue =
  com.giyeok.bibix.runner.ListValueKt.Dsl._create(com.giyeok.bibix.runner.BibixValueProto.ListValue.newBuilder()).apply { block() }._build()
public object ListValueKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.giyeok.bibix.runner.BibixValueProto.ListValue.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.giyeok.bibix.runner.BibixValueProto.ListValue.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.giyeok.bibix.runner.BibixValueProto.ListValue = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.giyeok.bibix.runner.BibixValueProto.ListValue.copy(block: com.giyeok.bibix.runner.ListValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.runner.BibixValueProto.ListValue =
  com.giyeok.bibix.runner.ListValueKt.Dsl._create(this.toBuilder()).apply { block() }._build()
