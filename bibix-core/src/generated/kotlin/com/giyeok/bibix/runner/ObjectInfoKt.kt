...
public object ObjectInfoKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.giyeok.bibix.runner.BibixRepoProto.ObjectInfo.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.giyeok.bibix.runner.BibixRepoProto.ObjectInfo.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.giyeok.bibix.runner.BibixRepoProto.ObjectInfo = _builder.build()
