...
public inline fun tupleValue(block: com.giyeok.bibix.runner.TupleValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.runner.BibixValueProto.TupleValue =
  com.giyeok.bibix.runner.TupleValueKt.Dsl._create(com.giyeok.bibix.runner.BibixValueProto.TupleValue.newBuilder()).apply { block() }._build()
public object TupleValueKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.giyeok.bibix.runner.BibixValueProto.TupleValue.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.giyeok.bibix.runner.BibixValueProto.TupleValue.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.giyeok.bibix.runner.BibixValueProto.TupleValue = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.giyeok.bibix.runner.BibixValueProto.TupleValue.copy(block: com.giyeok.bibix.runner.TupleValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.runner.BibixValueProto.TupleValue =
  com.giyeok.bibix.runner.TupleValueKt.Dsl._create(this.toBuilder()).apply { block() }._build()
