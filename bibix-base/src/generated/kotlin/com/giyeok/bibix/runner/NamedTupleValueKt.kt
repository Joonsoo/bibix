...
public object NamedTupleValueKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.giyeok.bibix.runner.BibixValueProto.NamedTupleValue.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.giyeok.bibix.runner.BibixValueProto.NamedTupleValue.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.giyeok.bibix.runner.BibixValueProto.NamedTupleValue = _builder.build()
     ...
     */
     public val values: com.google.protobuf.kotlin.DslList<com.giyeok.bibix.runner.BibixValueProto.NamedValue, ValuesProxy>
      @kotlin.jvm.JvmSynthetic
