...
public inline fun listValue(block: com.giyeok.bibix.ListValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.BibixValueProto.ListValue =
  com.giyeok.bibix.ListValueKt.Dsl._create(com.giyeok.bibix.BibixValueProto.ListValue.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.giyeok.bibix.ListValue`
 */
public object ListValueKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.giyeok.bibix.BibixValueProto.ListValue.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.giyeok.bibix.BibixValueProto.ListValue.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.giyeok.bibix.BibixValueProto.ListValue = _builder.build()
    ...
    /**
     * `repeated .com.giyeok.bibix.BibixValue values = 1;`
     */
...
public inline fun com.giyeok.bibix.BibixValueProto.ListValue.copy(block: com.giyeok.bibix.ListValueKt.Dsl.() -> kotlin.Unit): com.giyeok.bibix.BibixValueProto.ListValue =
  com.giyeok.bibix.ListValueKt.Dsl._create(this.toBuilder()).apply { block() }._build()
